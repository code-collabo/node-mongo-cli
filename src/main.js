...
export let createProject = async (options) => {
    ...
    try {
        ...
        console.error(
            `\n%s "${options.template}" is (probably) an invalid template name i.e. not among template name stored in the templateCollection variable/array.`,
    ...
    const tasks = new Listr([
        ...
        },
        {
            ...
            skip: () =>
                !options.git
                    ? 'Automatically initialize git by doing nothing. Alternatively, pass --git or -g'
                    : undefined,
        },
        {
            ...
            skip: () =>
                !options.runInstall
                    ? 'Automatically install dependencies by doing nothing. Alternatively, pass --install or -i'
                    : undefined,
        },
    ])
    ...
    console.log(
        `%s Project bootstrapped into the folder you specified => ${options.folderName} <=`,
