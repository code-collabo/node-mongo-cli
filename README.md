...
-   See [contributor guide](https://code-collabo.gitbook.io/docs/contributor-guide/contributor-guide) which contains **_contributing.md_**, **_CODE_OF_CONDUCT_**, **_git workflow_** and **_project development setup_** to help you get started.
